<template>
  <div class="about">
    ...
    <p><label for="data_hora_cadastro">Data/Hora Cadastro: </label><input id="dataHoraCadastro" type="datetime-local" v-model="vocabulo.dataHoraCadastro"/></p>
    <p><label for="data_hora_desativacao">Data/Hora Desativação: </label><input id="dataHoraDesativacao" type="datetime-local" v-model="vocabulo.dataHoraDesativacao"/></p>
...
function status(dataHoraDesativacao: string | null) {
